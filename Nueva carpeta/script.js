...
function setActiveLink() {
  const sections = ["inicio", "nosotros", "servicios", "casos", "galeria", "metodo", "contacto"];
...
if (window.gsap && window.ScrollTrigger) {
  ...
  gsap.utils.toArray([".section-head", ".service-card", ".case-swiper", ".gallery-grid", ".method-panel", ".about-band", ".contact-panel"]).forEach((el, idx) => {
    gsap.to(el, {
      opacity: 1,
      y: 0,
      duration: 0.75,
